...
function migrateDatabase(db) {
    ...
    if (expCreateSql && !expCreateSql.sql.includes("'insight'")) {
        ...
        try {
            ...
            db.exec(SCHEMA_SQL);
            db.exec(`INSERT INTO experiences SELECT id, type, trigger_text, action_text, outcome_text,
        ...
        FROM experiences_old`);
            ...
            try {
                ...
                console.error(`[ACM] migrateDatabase: ROLLBACK failed during experiences type migration. ` +
