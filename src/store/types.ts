...
export interface AcmConfig {
  ...
  embedder_init_timeout_ms: number; // Embedder.initialize() timeout, 0 = unlimited (default: 30000; 30s covers first-run model download on slow networks)
  pre_compact_budget_ms: number; // PreCompact Phase 2 overall budget, 0 = unlimited (default: 30000)
}
...
export const DEFAULT_CONFIG: AcmConfig = {
  ...
  embedder_init_timeout_ms: 30_000,
  pre_compact_budget_ms: 30_000,
};
